...
- Current `~/Library/Application Support/org.openevo.desktop` state, including
  run-retry recovery data, retention and cleanup:
- Preserved legacy Preview `~/.openevo/desktop` data retention and cleanup:
