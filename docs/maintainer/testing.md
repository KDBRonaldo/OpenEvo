...
`product_committed`; tests prove the native command rejects native-owned and
unknown values. These stages never count as success evidence. The V2 renderer marker is
