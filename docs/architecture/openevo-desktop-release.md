...
This scaffolding is not release evidence. In particular, source builds and
presence-only artifact checks do not prove that a mounted and copied app starts
or completes the science workflow.
...
- the supported Python version and locked sidecar build dependencies;
...
3. create and validate its descriptor and SHA256;
