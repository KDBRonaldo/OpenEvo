...
Move development-process specs and plans out of release-facing docs:

```text
docs/superpowers/specs/2026-07-09-openevo-productization-design.md
  -> docs/maintainer/productization/spec.md
docs/superpowers/plans/2026-07-09-openevo-productization-implementation.md
  -> docs/maintainer/productization/implementation-plan.md
```

After the move, update `tests/ci/test_openevo_productization_workflow.py` to
read `docs/maintainer/productization/implementation-plan.md`.
