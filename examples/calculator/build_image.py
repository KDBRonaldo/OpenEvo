...
DEFAULT_IMAGE = "openevo-localhost-calculator:latest"
IMAGE_LAYOUT_VERSION = "3"
IMAGE_VERSION_LABEL = "io.openevo.calculator-image-version"
...
def main() -> int:
    ...
    run_command(
        [
            ...
            "build",
            "--build-arg",
            f"OPENEVO_CALCULATOR_IMAGE_VERSION={IMAGE_LAYOUT_VERSION}",
            "--tag",
            args.image,
            str(DOCKERFILE_DIR),
        ]
