...
rollout/gateway logs.
    ...
    uv run python examples/research-benchmarks/calculator/run.py                 # docker (default)
    uv run python examples/research-benchmarks/calculator/run.py --backend apptainer
"""
