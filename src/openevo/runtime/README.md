...
displaced object is preserved and the cleanup fails closed. Directory cleanup
applies the same bind/quarantine/recheck sequence independently to every child;
it never validates a child and later unlinks that original child name.
