    ...
    <div className="workspace-stack" data-testid="evolution-workspace">
      ...
      {standaloneAvailable ? <section ref={resultSectionRef} id="evolution-result" className="product-panel task-panel evolution-step-section">
        {resultView === "history" ? <>
          ...
          })}</nav> : <div className="empty-row">No Evolution Run yet. Session evidence remains available until you choose to use it.</div>}
          ...
          <article className={`v2-evolution-job v2-current-evolution-run ${latestRun.state}`}>
