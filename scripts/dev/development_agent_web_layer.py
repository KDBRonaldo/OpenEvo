#!/usr/bin/env python3
"""Browser-facing WebUI adapter for the formal OpenEvo product daemon.

This module is intentionally kept under ``scripts/dev``.  It projects the small,
working remote daemon into renderer-safe v2 models while its own composition is
migrated separately.
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Serve the development Desktop UI and v2 Web Layer."
    )
